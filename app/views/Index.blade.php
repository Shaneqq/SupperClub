...
<html lang="en" class="no-js" >
    <head>
        ...
        <!-- CUSTOM CSS -->
        {{HTML::style('assets/css/style-blue.css')}}
            ...
            <div class="container">
                ...
                <div class="row animate-in" data-anim-type="fade-in-up">
                    ...
                    <div style="text-align: center"class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                         <a  href="#services" class=" btn button-custom btn-custom-two">Join The Club Today</a>
                         
                         <h1>Recent Events</h1>
                         <h2>Recent Successfully Hosted Suppers</h2>
                     </div>
                </div>
    ...
    {{HTML::script('assets/js/vegas/jquery.vegas.min.js')}}

    <!-- VEGAS SLIDESHOW SCRIPTS -->
    {{HTML::script('assets/js/jquery.easing.min.js')}}

    <!-- FANCYBOX PLUGIN -->
    {{HTML::script('assets/js/source/jquery.fancybox.js')}}

    <!-- ISOTOPE SCRIPTS -->
    {{HTML::script('assets/js/jquery.isotope.js')}}

    <!-- VIEWPORT ANIMATION SCRIPTS   -->
    {{HTML::script('assets/js/appear.min.js')}}

    {{HTML::script('assets/js/animations.min.js')}}
